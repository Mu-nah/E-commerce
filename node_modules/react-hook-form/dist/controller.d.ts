...
declare const Controller: <TAs extends "input" | "select" | "textarea" | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | React.ComponentClass<any, any> | React.FunctionComponent<any>, TControl extends Control<Record<string, any>> = Control<Record<string, any>>>(props: import("./types").Assign<({
    ...
    as?: undefined;
    render: (data: import("./types").ControllerRenderProps<TControl>) => React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)>;
} & {
    name: import("./types").FieldName<import("./types").FieldValuesFromControl<TControl>>;
    rules?: Partial<{
        required: string | boolean | import("./types").ValidationValueMessage<boolean>;
