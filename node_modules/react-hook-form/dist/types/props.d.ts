...
import { UseFormMethods, FieldValues, FieldValuesFromControl, FieldName, Control, Assign } from './';
...
export declare type ControllerRenderProps<TControl extends Control = Control> = {
