...
export declare type Control<TFieldValues extends FieldValues = FieldValues> = Pick<UseFormMethods<TFieldValues>, 'register' | 'unregister' | 'setValue' | 'getValues' | 'trigger'> & {
    ...
    fieldArrayValuesRef: React.MutableRefObject<Record<FieldArrayName, unknown[]>>;
    shouldUnregister: boolean;
...
export declare type SetFieldValue<TFieldValues> = FieldValue<TFieldValues> | UnpackNestedValue<DeepPartial<TFieldValues>> | string[] | undefined | null | boolean;
...
export declare type UseField<TControl extends Control = Control> = {
